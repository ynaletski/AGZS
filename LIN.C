...
//---------------
//---------------
// данные записываемые в цикле, SLOT4
...
//---------------
// данные записываемые в цикле, SLOT5
// только для режима ГРК N2
...
//            buf_tmp[0]=addr;
            ...
            //buf_tmp[6]= 4;  // количество байт
              ...
              case mDat3w: // запись данных
                       LIn_D=&LIn_Dat3w[0];
                       goto m1;
              case mDat4w: // запись данных
                       LIn_D=&LIn_Dat4w[0];
                       goto m1;
              case mDat5w: // запись данных
                       LIn_D=&LIn_Dat5w[0];
                       goto m1;
...
//       if(count < (LIn_Lgth1+LIn_Lgth1+5) )
       ...
       if(count == (LIn_Lgth1+LIn_Lgth1+5) )     // 3 резервуара
       {
         SizeL=LInd_max1;
         goto m_rd_Slot1;
       }
       if(count == (LIn_Lgth1+LIn_Lgth1+5-20) )  // 2 резервуара
       {
         SizeL=LInd_max1-5;
         goto m_rd_Slot1;
       }
   ...
   m_rd_Slot2:
      ...
      case mDat4w:    //ответ на команду записи
      case mDat5w:    //ответ на команду записи
...
//              sw_dns=12;
    ...
    MmiGotoxy(0,1); MmiPuts("       == Stop (Host) ==      ");
      ...
      case 23: // запуск измерения плотности в резервуаре 3
